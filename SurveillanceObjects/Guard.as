package SurveillanceObjects {
	...
	public class Guard extends UIComponent {
		...
		private var walkingTimer:Timer = new Timer(50);
		
		private var _graphCoordinates:GraphCoordinates = null;
		private var _graph:IGraph = null;
		
		public function Guard() {
			walkingTimer.addEventListener(TimerEvent.TIMER, onWalk);
			walkingTimer.start();
		}
